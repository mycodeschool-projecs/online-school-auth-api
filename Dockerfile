...
LABEL version="1.0"
LABEL description="Docker image for online-school-auth-api Spring Boot application"
...
ENTRYPOINT ["java","-jar","/app/target/online-school-auth-api-0.0.1-SNAPSHOT.jar"]